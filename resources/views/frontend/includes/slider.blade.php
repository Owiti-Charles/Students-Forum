                    ...
                    <ul>
                        ...
                        <li data-transition="slotslide-horizontal">
                            ...
                            <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                                 ...
                                 style="z-index: 5; white-space: nowrap; font-size: 50px; color:#fff;    font-family: 'Trirong', serif;">Share Knowledge and Information
                            </div>
                            <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                        ...
                        <li data-transition="slotslide-vertical">
                            ...
                            <!-- MAIN IMAGE -->
                            <img src="images/slider/slider_13.jpg"  alt="">
                            <div class="ed_course_single_image_overlay"></div>
                            ...
                            <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                                 ...
                                 style="z-index: 5; white-space: nowrap; font-size: 50px; color:#fff;     font-family: 'Trirong', serif;">Download Course Materials
                            </div>
                            <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                                 ...
                                 style="z-index: 5; white-space: nowrap; font-size: 50px; color:#fff;    font-family: 'Trirong', serif;">Whenever You Want....
                            </div>
