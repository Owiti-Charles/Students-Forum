                ...
                @foreach($discussions as $key=>$discussion)
                    <tr>
                        ...
                        <td class="center">
                            ...
                            <a href="{{route('admin.discussion.view', $discussion->id)}}"><button style="color: green;" type="button"  class="btn btn-icon command-edit waves-effect waves-circle" ><span class="zmdi zmdi-eye" ></span></button></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- content goes here -->
                <form id="updateform" method="POST" action="{{route('admin.discussion.update')}}">
                    {{csrf_field()}}
