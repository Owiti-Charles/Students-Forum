    ...
    <div class="timeline">
        <div class="t-view" data-tv-type="text">
            ...
            <div class="tv-body">
                ...
                <a class="tvc-more" href=""><i class="zmdi zmdi-mode-comment"></i> View all{{$discussion->$threads}} 
                    Comments</a>
            </div>
            ...
            <div class="tv-comments">
                <ul class="tvc-lists">
                            ...
                            @if(Auth::user()->id==$thread->user_id)
                                <div class="pull-right">
                                    <div class="actions dropdown">
                                        ...
                                        <form method="POST" action="{{route('thread.delete', $thread->id)}}" id="{{Auth::user()->id}}" style="display: none">
                                            {{csrf_field()}}
                    ...
                    @empty
                        <li class="media">
                            <div class="media-body">
                                <div class="m-t-10" style="color: #dd7b0b">No comments for this discussion at the moment</div>
                            </div>
                        </li>
                    @endforelse
                    <form action="{{route('thread.create', $discussion->id)}}" method="POST">
                        {{csrf_field()}}
                        <li class="p-20">
                            <div class="fg-line">
                                <textarea class="form-control auto-size" placeholder="Write a reply..." name="thread"></textarea>
                            </div>
...
@section('scripts')
    <script type="text/javascript">
        function editThread(id) {
            var submiturl = "{{URL::to('student/discussion/thread/fetch/')}}";
            $.ajax({
                url: submiturl + '/' + id,
                type: 'GET',
                data: '',
