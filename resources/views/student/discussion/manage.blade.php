                ...
                @foreach($discussions as $key=>$discussion)
                    <tr>
                        ...
                        <td class="center">
                            ...
                            <a href="{{route('student.discussion.view', $discussion->id)}}"><button style="color: green;" type="button"  class="btn btn-icon command-edit waves-effect waves-circle" ><span class="zmdi zmdi-eye" ></span></button></a>
                            ...
                            <form action="{{route('student.discussion.destroy', $discussion->id)}}" style="visibility: hidden;" method='POST' id="{{$discussion->id}}" class="pull-left">
                                &nbsp&nbsp
                                {{csrf_field()}}
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- content goes here -->
                <form id="updateform" method="POST" action="{{route('student.discussion.update')}}">
                    {{csrf_field()}}
    ...
    <script type="text/javascript">
        ...
        function getData(id){
            swal({
                ...
                if (isConfirm) {
                    var submiturl = "{{URL::to('student/discussion/fetch')}}";
                    var content="";
                    var file="";
                    var description="";
                    $.ajax({
