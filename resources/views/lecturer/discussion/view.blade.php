        ...
        <div class="t-view" data-tv-type="text">
            <div class="tv-header media">
                <a href="" class="tvh-user pull-left">
                    <img class="img-responsive" src="{{URL::to('profile/'. Auth::user()->image)}}" alt="">
                </a>
            ...
            <div class="tv-comments">
                <ul class="tvc-lists">
                    ...
                    @endforelse
                    <form action="{{route('lecturer.thread.create', $discussion->id)}}" method="POST">
                        {{csrf_field()}}
                        <li class="p-20">
                            <div class="fg-line">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- content goes here -->
                    <form action="{{route('lecturer.thread.update')}}" method="POST">
                        {{csrf_field()}}
...
@section('scripts')
    <script type="text/javascript">
        function editThread(id) {
            var submiturl = "{{URL::to('lecturer/discussion/thread/fetch/')}}";
            $.ajax({
                url: submiturl + '/' + id,
                type: 'GET',
                data: '',
