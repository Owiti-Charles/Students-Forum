  ...
  "use strict";
	...
	//  event on map/image js     
		...
		$('.on_image').on("click", function() {
			$('.ed_event_wrapper_item_img').html('<img src="http://kamleshyadav.com/html/educo/educo/educo_default/js/images/slider/sec1_s5.jpg" alt="item1" class="img-responsive">');
			$('.on_image').hide();
			$('.on_map').show();
		});
