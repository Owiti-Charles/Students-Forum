        ...
        var tnLink,
            ...
            create = function(path) {
                ...
                if (settings.lazyLoad) {
                    ...
                    //tnLink = '<div class="owl-video-tn" style="opacity:1;background-image:url('http://localhost/webforum/public/frontend/js/ + path + ')"></div>';
                    //tnLink = '<div class="owl-video-tn" style="opacity:1;background-image:url('http://kamleshyadav.com/html/educo/educo/educo_default/js/ + path + ')"></div>';
                }
